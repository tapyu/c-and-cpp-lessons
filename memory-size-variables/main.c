...
int main() {
    ...
    signed int i = 32767; // The maximum value that can be represented in a signed int
    ...
    signed int s = 32767; // The maximum value that can be represented in a signed short
